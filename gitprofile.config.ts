...
const CONFIG = {
  ...
  resume: {
    fileUrl:
      'https://drive.google.com/uc?export=download&id=1djiAwrkcNEpVm6BQr7qO-3xYfSHB8SSu', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    {
  ...
  blog: {
    ...
    username: 'nazhifkojaz', // to hide blog section, keep it empty
